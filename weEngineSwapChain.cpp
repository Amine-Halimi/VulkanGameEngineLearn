...
/*
* Implementation of the weEngineSwapChain object provided by the tutorial. Modified to fit with the weEngine 
* 
...
namespace weEngine {
    ...
    */
    VkResult weEngineSwapChain::acquireNextImage(uint32_t *imageIndex) 
    {
      vkWaitForFences(
          device.device(),
          1,
    ...
    */
    ...
    /*
    * Blueprint to define how to render the framebuffers
    * Defines the attachment depth attachment, the color attachment
    */

    void weEngineSwapChain::createRenderPass() {
    ...
    */
    ...
    void weEngineSwapChain::createDepthResources() {
    ...
    void weEngineSwapChain::createSyncObjects() {
    ...
    */
    ...
    VkPresentModeKHR weEngineSwapChain::chooseSwapPresentMode(
    ...
    VkExtent2D weEngineSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
    ...
    VkFormat weEngineSwapChain::findDepthFormat() {
